    ...
    <div class="cb-body">
        <form method="POST" action="" id="userForm" name="userForm" novalidate>
            ...
            <label>
                ...
                <input type="password" name="pass" value="<?php echo $userInfos ?  $userInfos->pass : '' ?>" username required>
            </label>
                ...
                <select name="id_state">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_object()) {
                            ...
                            ' . ($userInfos ? ($userInfos->id_state == $row->id_state ? 'selected' : '') : '') . '>' . $row->nome . ' (' . $row->uf . ')</option>';
                        }
                    }
                    ?>
                </select>
