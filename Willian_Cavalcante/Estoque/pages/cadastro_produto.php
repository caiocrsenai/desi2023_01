<!-- <form method="POST" action="cadastro_produto.php">
    ...
    Fornecedor: <select name="supplier_id">
    </select><br>
    ...
    <div class="cb-body">
        <form method="POST" action="" id="userForm" name="userForm" novalidate>
            ...
            <label>
                ...
                <input type="text" name="description" value="<?php echo $pageObjInfos ? $pageObjInfos->description : '' ?>" required>
            </label>

            <label>
                <div class="lbl">Senha</div>
                <input type="password" name="pass" value="<?php echo $pageObjInfos ? $pageObjInfos->pass : '' ?>" required>
            </label>

            <label>
                <div class="lbl">preço</div>
                <input type="price" name="price" id="price" value="<?php echo $pageObjInfos ? $pageObjInfos->price : '' ?>" required>
            </label>
