    ...
    <div class="cb-body">
        <div class="table-container">
            <table>
                ...
                <tbody>
                    <?php
                    $sql = "SELECT product.name, product.id, product.price, product.codebar, product.id_category, category.name as category_name FROM product inner join category on category.id = product.id_category";
                    $result = $con->query($sql);
