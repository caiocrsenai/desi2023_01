        ...
        <div class="cb-body">
         ...
         <label>
                ...
                <select name="category">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_object()) {
                            echo '<option value="' . $row->id_category . '" ' . ($categoryInfos ? ($categoryInfos->id_category == $row->id_category ? 'selected' : '') : '') . ' >' . $row->name . '</option>';
                        }
                    }
                    ?>
                </select>
            ...
            <label>
                ...
                <input type="number" name="price" min="0.00" max="10000.00" step="0.01" name="price" value="<?php echo $productInfos ?  $productInfos->price : '' ?>"/>
            </label>
