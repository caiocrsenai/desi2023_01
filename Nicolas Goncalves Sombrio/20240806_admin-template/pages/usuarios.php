                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a href="?page=usuario&id=<?php echo $row->id; ?>" class="btn-status color-blue"><i class="fa-regular fa-pen-to-square"></i></a>
                                </td>
                                <td>
                                    <div data-id="<?php echo $row->id; ?>" class="delete-user btn-status color-red">
