...
if (!empty($_POST)) {
    ...
    if ($result) {
        ...
        echo "<script>alert('Estoque " . $_POST['name_product'] . " " . $action . " com sucesso!'); window.location.href = '?page=estoques' </script>";
    }
}
    ...
    <div class="cb-body">
        <form method="POST" action="" id="stockForm" name="stockForm" novalidate>
            ...
            <label>
                ...
                <input type="number" name="quantity" value="<?php echo $stockInfos ? $stockInfos->quantity : '' ?>" required>
            </label>
