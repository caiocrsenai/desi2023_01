...
if (!empty($_GET['id'])) {
    ...
    if ($con->affected_rows > 0) {
        echo "<script>alert('Estoque do produto ". $_GET['nameProduct'] . " excluido com sucesso!'); window.location.href = '?page=estoques'</script>";
    }
}
...
<div class="container-box flex-1">
    <div class="cb-header">
        <div class="cb-title">Estoque de produto</div>
    </div>
    <div class="cb-body">
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <div class="delete-stock btn-status color-red" data-id="<?php echo $row->id; ?>" data-name="<?php echo $row->name; ?>">
    ...
    _qsa('.delete-stock').forEach(function(_element) {
        _element.addEventListener('click', function(e) {
            ...
            if (confirm('Você deseja realmente excluir o estoque do produto?')) {
                ...
                window.location.href = '?page=estoques&id=' + dataId + '&nameProduct=' + dataName;
            }
        });
    });
</script>