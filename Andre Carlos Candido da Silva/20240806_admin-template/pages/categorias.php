...
if (!empty($_GET['id'])) {
    ...
    if ($con-> affected_rows > 0) {
        ...
        echo "<script>alert('categoria excluida sucesso!')</script>";
    }
}
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><a href="?page=categoria&id=<?php echo $row->id ?>" class="btn-status color-blue">
...
<script>
    _qsa('.delete-category').forEach(function(_element) {
        ...
        _element.addEventListener('click', function(e) {
            ...
            if (confirm('você realmente deseja excluir a categoria?')) {
