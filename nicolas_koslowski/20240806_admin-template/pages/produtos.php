                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <div class="delete-prouto btn-status color-red" data-id="<?php echo $row->id; ?>">
...
<script>
    _qsa('.delete-produto').forEach(function(_element) {
        _element.addEventListener('click', function(e) {
            const _this = this,
                dataId = _this.getAttribute('data-id');

            if (confirm('Você deseja realmente excluir o produtos?')) {
